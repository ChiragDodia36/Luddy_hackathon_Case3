...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final GtfsLibraryAccessors laccForGtfsLibraryAccessors = new GtfsLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>gtfs</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public GtfsLibraryAccessors getGtfs() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForGtfsLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class GtfsLibraryAccessors extends SubDependencyFactory {
        private final GtfsRealtimeLibraryAccessors laccForGtfsRealtimeLibraryAccessors = new GtfsRealtimeLibraryAccessors(owner);

        public GtfsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>gtfs.realtime</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GtfsRealtimeLibraryAccessors getRealtime() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGtfsRealtimeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GtfsRealtimeLibraryAccessors extends SubDependencyFactory {

        public GtfsRealtimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>bindings</b> with <b>com.google.transit:gtfs-realtime-bindings</b> coordinates and
         * with version reference <b>gtfsRealtime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getBindings() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("gtfs.realtime.bindings");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>gtfsRealtime</b> with value <b>0.0.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGtfsRealtime() { return getVersion("gtfsRealtime"); }
